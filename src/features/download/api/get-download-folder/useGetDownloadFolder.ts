 ...
 * Distinct key from the settings slice; staleTime 0 refetches on every mount. */
export function useGetDownloadFolder(options?: Omit<UseQueryOptions<string, Error, string>, 'queryKey' | 'queryFn'>) {

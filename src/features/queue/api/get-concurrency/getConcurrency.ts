...
/** Initial queue concurrency. Goes through the shared ['settings'] cache so a copy
 * already loaded by Ajustes is reused (staleTime Infinity mirrors useGetSettings). */

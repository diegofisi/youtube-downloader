  ...
  <Stack gap="none" className="mx-auto my-10 max-w-115 text-center">
    ...
    <Stack gap="sm" className="mb-5.5 gap-2.5 text-left">
      {benefits().map((b) => (
        ...
        >
          <Span className="flex size-6.5 flex-none items-center justify-center rounded-lg bg-success-soft text-success">
    ...
    <Small className="mt-3.25 text-[11.5px] font-normal text-faint">
      {t(

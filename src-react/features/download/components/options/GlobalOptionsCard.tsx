    ...
    {opts.mode !== 'audio' && (
      <Stack gap="md" className="mt-[14px] gap-[14px] border-t border-border pt-[14px]">
        ...
        <Stack gap="xs">
          ...
          <ChipGroup options={containerChips()} value={opts.container} onChange={(container) => onOptsChange({ container })} />
        </Stack>
      </Stack>
    )}
    ...
    {opts.mode === 'audio' && (
      <Stack gap="md" className="mt-[14px] gap-[14px] border-t border-border pt-[14px]">
        <Stack gap="xs">
          ...
          <ChipGroup options={audioFmtChips()} value={opts.audioFmt} onChange={(audioFmt) => onOptsChange({ audioFmt })} />
        </Stack>
        <Stack gap="xs">
          <Small className="text-[11.5px] font-semibold text-muted-foreground">
